sprep96 -HS 0 -HR 0 -M W2.d -d dfile -R -NMOD 1 -PER 20 #-PARR period.dat
sdisp96
#sdpsrf96 -R -XMIN 0 -XMAX 2 -YMIN 2.5 -YMAX 4.5 -TXT
...
sdpder96 -R -K 2 -XLEN 3 -X0 1 -YLEN 4 -YMIN 0 -YMAX 199
plotnps -F6 -W9 -EPS < SRDER.PLT > regn.eps
