...
c output resolution matrix
      open(9999,file='resomatrix.dat')
      do i=1,nm
        do j=1,nm
c            tmpval=res(i,j)
c            write(9999,99999) i,j,tmpval
          if(i.eq.j) then
              tmpval=res(i,j)
              write(9999,99999) i,j,xk1(i),yk1(i),tmpval
          endif
99999 format(i3," ",i3," ",f11.6," ",f11.6," ",f9.6)
        enddo
      enddo
      close(9999)
