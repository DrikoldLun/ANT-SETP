...
#file=c${T}s.dat
file=TEST_0.1_200_1000_${T}.1
resofile=reso${T}s.dat
topo=../../../GMTdata/ANTsichuan.grd
fault=../../../../lms/fault.cn

#gmt grdcut $topo -R$R -Gcut.grd
makecpt -Cseis1.cpt -T2.4/3.4/0.001 > tmp.cpt
...
grdfilter tmp2.grd -Fg0.4 -D0 -Gtmp3.grd
...
grdcontour tmp3.grd -R$R -J$J -C0.1 -D -L0.49/0.51
awk '{print $1,$2}' contour_0.5_0*.xyz|psclip -R$R -J$J -K -O >> $PS
...
psscale -Ctmp.cpt -D9/-1/8/0.2h -Ba0.2:"Group vel(km/s)": -O -K -I -V >> $PS
ps2pdf $PS $PDF
